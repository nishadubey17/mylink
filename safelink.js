var Base64 = { 
    ...
    encode: function (input) { 
        ...
        var i = 0; 
        input = Base64. \ _ utf8 \ _encode (input); 
        while (i <input.length) { 
            ...
            output = output + this. \ _ keyStr.charAt (enc1) + this. \ _ keyStr.charAt (enc2) + this. \ _ keyStr.charAt (enc3) + this. \ _ keyStr.charAt (enc4); 
        } 
        return output; 
    }, 
    decode: function (input) { 
        ...
        output = Base64. \ _ utf8 \ _decode (output); 
        return output; 
    },
...
function auto_safelink () { 
    ...
    for (var i = 0; i <a \ _to \ _va; 
        ...
        if (a \ _to \ _vh == false) { 
            ...
            a \ _to \ _ve \ [i \]. href = "https://allhospitalinfo.com/downloads?url=" + encryptedUrl; https://allhospitalinfo.com/safelink ? url = "+ encryptedUrl;
            a \ _to \ _ve \ [i \]. rel = "nofollow"; 
            a \ _to \ _vb ++; 
            a \ _to \ _vc + = i + ":::" + a \ _to \ _ve \ [i \]. href + "n"; 
        } 
    } 
    var a \ _to \ _vj = document.
